                ...
                <page size="A4">
                    ...
                    <div>
                      ...
                      <table width="100%" border="0" >
                          <tr>
                              <td style="padding: 10px;background-color: #dedede;"><span style="font-size: 15px;font-weight: bold;">#</span></td>
                            ...
                            <?php $arrayItem = -1; $i=0; foreach ($model['data'] as $key_qt => $value_qt) { $i++; $arrayItem++; ?>
                              <tr >
                                  ...
                                  <td style="padding: 10px;width: 50px;text-align: right;">
                                    <?= $value_qt['catalog_no']; ?>
                                    <input type="hidden" name="Project[<?php echo $arrayItem; ?>][name]" value=<?php echo $value_qt['catalog_no']; ?>>
                                  </td>
                                  <td style="padding: 10px;width: 5px;text-align: right;">
                                    <?= $quantity = $value_qt['quantity']; ?>
                                    <input type="hidden" name="Project[<?php echo $arrayItem; ?>][quantity]" value=<?php echo $quantity; ?>>
                                  </td>
                                      ...
                                      <dl>
                                          ...
                                          <dd>
                                              <?php if ($value_qt['freight_per_item'] == 'Yes') { ?>
                                                ...
                                                <ins><b><?php echo $priceLst = number_format((float)$tot - $totDisPerItem + $totFreight,2,'.',','); ?></b></ins>

                                                <input type="hidden" name="Project[<?php echo $arrayItem; ?>][price]" value=<?php echo round($tot - $totDisPerItem + $totFreight,2); ?>>
...
<div>
                        ...
                        <?php if ($country_user == 129) { ?>
                          ...
                          <span style="color: red;">* Order Is Less Than RM200.00, Extra Processing Fee Of RM50.00 Will Be Charged Upon Checkout.</span>
                        ...
                        <?php } elseif ($country_user == 209 || $country_user == 100 || $country_user == 168 || $country_user == 230 || $country_user == 188 || $country_user == 36 || $country_user == 116 || $country_user == 32) { ?>
                          ...
                          <span style="color: red;">* Order Is Less Than 100.00 USD, Extra Processing Fee Of 20.00 USD Will Be Charged. Upon Checkout.</span>
