                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($data->read_unread == 1) { ?>
                                                        ...
                                                        <?= Html::a('ORDER STATUS',[$data->path,'id' => (string)$data->_id,'module' => $data->module], ['class' => 'btn btn-default']) ?>

                          
                                                    <?php } else { ?>

                                                        <?= Html::a('ORDER STATUS', ['detail', 'id' => (string)$model['_id']], ['class' => 'btn btn-default']) ?>

                                                    <?php } ?>


                                                    <?= Html::a('IN '.$model['invoice_no'].'F', ['invoice', 'id' => (string)$model['_id']], ['class' => 'btn btn-default']) ?>
