                  ...
                  <?php } ?>
                    ...
                    <div>
                        ...
                        <span class="pull-right">
                            ...
                            <select class="form-control currency" id="currency" disabled>
                    ...
                    <div>
                        ...
                        <?php if ($country_user == 129) { ?>
                          ...
                          <span class="text-red" style="display: none;">* Order Is Less Than RM200.00, Extra Processing Fee Of RM50.00 Will Be Charged Upon Checkout.</span>
                        ...
                        <?php } elseif ($country_user == 209 || $country_user == 100 || $country_user == 168 || $country_user == 230 || $country_user == 188 || $country_user == 36 || $country_user == 116 || $country_user == 32) { ?>
                          ...
                          <span class="text-red" style="display: none;">* Order Is Less Than 100.00 USD, Extra Processing Fee Of 20.00 USD Will Be Charged. Upon Checkout.</span>
                        ...
                        <span class="text-red">* <?php echo $models->unable; ?></span>
