...
$this->title = 'Revise : #'.$models->myRFQ;
                  ...
                  <?php } ?>
                      ...
                      <table border="0" width="100%">
                          <tr>
                              ...
                              <td style="width: 130px;vertical-align: top;">
                                ...
                                <span style="font-size: 15px;font-weight: bold;">QT <?= $models->quotation_no ?>-R<?= $models->reviseCount ?></span>
                          ...
                          <tr>
                              ...
                              <td style="width: 5px;vertical-align: top;"><span style="font-size: 15px;"></span></td>
                              <td colspan="4"><b>Contact No</b> : <?= $models->contact_no ?></td>
                          </tr>
                          <tr>
                              <td style="width: 70px;vertical-align: top;"><span style="font-size: 15px;"></span></td>
                              <td style="width: 5px;vertical-align: top;"><span style="font-size: 15px;"></span></td>
                              <td colspan="4"><b>Email</b> : <?= $models->email ?></td>
                          </tr>
                          <?php } else { ?>
                            ...
                            <?php $arrayItem = -1; $i=0; foreach ($models['data'] as $key_qt => $value_qt) { $i++; $arrayItem++; ?>
                              <tr >
                                  ...
                                  <td style="padding: 10px;width: 10px;text-align: right;">
                                    ...
                                    'class' => 'btn btn-warning btn-sm editItem',
                                    'id'=>'editItem',
                                    'style'=>'cursor:pointer;',
                                    'data-target'=>'#m_modal_4',
                                    'data-toggle'=>'modal'
                    ...
                    <div>
                        <table width="100%" border="0">
                          ...
                          <tr>
                            <td colspan="4" class="text-left"><span style="font-size: 15px;"> 
                          ...
                          <tr>
                            ...
                            <td class="text-right"><span style="font-size: 20px;" class="">
                              <b>
